 ...
 */
public class DgjjMarketDetailDto {
	...
	public String getMyDriveCash() {
		return myDriveCash;
	}

	public void setMyDriveCash(String myDriveCash) {
		this.myDriveCash = myDriveCash;
	}
	...
	public String getTechAreaText() {
		return techAreaText;
	}

	public void setTechAreaText(String techAreaText) {
		this.techAreaText = techAreaText;
	}
